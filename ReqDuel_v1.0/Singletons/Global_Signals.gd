...
var card_data = {
	...
	"M11": {"cardImage": "res://Assets/IMG/Mitigacion/M11.png", "cardName": "Reorganización de Recursos", "cost": 2, "type": "Mitigacion", "description": "Devuelve a la mano una carta de solución descartada anteriormente."},
	"M12": {"cardImage": "res://Assets/IMG/Mitigacion/M12.png", "cardName": "Iniciativa de Comunidad", "cost": 2, "type": "Mitigacion", "description": "Satisface parcialmente un stakeholder a elección."},
	"M13": {"cardImage": "res://Assets/IMG/Mitigacion/M13.png", "cardName": "Segunda Opcion", "cost": 5, "type": "Mitigacion", "description": "Saca 3 cartas de solución, 1 de las cartas es una solución inmediata a un stakeholder en juego."},
	"M14": {"cardImage": "res://Assets/IMG/Mitigacion/M14.png", "cardName": "Cotización", "cost": 3, "type": "Mitigacion", "description": "Reduce el costo de todas las soluciones durante este turno en $1."}
}
var enemy_card_data = {
	"Q01": {
